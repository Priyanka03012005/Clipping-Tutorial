...
public class CSLFrame extends JFrame{
    CSLFrame(){
        JFrame newFrame = new JFrame("Clipping Tutorial -> Line -> Cohen Sutherland Line Clipping Algorithm");
        newFrame.setSize(1200, 800);
        newFrame.setLayout(null);

        JLabel label = new JLabel("Cohen Sutherland Line Clipping Algorithm");
        ...
        OutputButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    CSLBeforeClip cslBeforeClip = new CSLBeforeClip(x1,y1,x2,y2,Wxmin,Wymin,Wxmax,Wymax);
                    newFrame.dispose();
                } catch (NumberFormatException ex) {
                    JOptionPane.showMessageDialog(CSLFrame.this, "Please enter valid integer values.");
                }
            }
        });
